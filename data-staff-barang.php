...
<head>
    ...
    <title>Data Barang - SISTEM ADMINISTRASI MedShop</title>
...
<body>
        ...
        <div class="tab">
            <div style="background-color: #7ECA9C;" class="card">
                <div style="background-color: #7ECA9C;" class="border-0 card-header">
                    <h5 class="text-light card-title">Data Barang - SISTEM ADMINISTRASI MedShop</h5>
                </div>
                <div class="card-body"> 
    ...
    <div class="modal-dialog">
        ...
        <div class="border-0 modal-header">
            <h5 class="text-light fw-bolder modal-title" id="exampleModalLabel">MedShop</h5>
